...
##   $ docker build -t tomcat-for-sonalgajbhiye2003-odoo .
##
## RUNNING
##   $ docker run -p 8080:8080 tomcat-for-sonalgajbhiye2003-odoo
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="hb427w2" \
    STACKSMITH_STACK_NAME="Tomcat for Sonalgajbhiye2003/ODOO" \
